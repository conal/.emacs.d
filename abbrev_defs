...
(define-abbrev-table 'global-abbrev-table
  '(
    ...
    ("si" #("is" 0 1 (font-lock-fontified t fontified t) 1 2 (font-lock-fontified t fontified t)) nil 1)
    ("siad" "said" nil 12)
    ("sicne" "since" nil 58)
    ("simeq'" "≃" nil 1)

...
(define-abbrev-table 'global-abbrev-table
  '(
    ...
    ("m'd'p" #("Markov decision process" 0 23 (fontified t face markdown-reference-face)) nil 1)
    ("m'd'ps" #("Markov decision processes" 0 25 (fontified t face markdown-reference-face)) nil 1)

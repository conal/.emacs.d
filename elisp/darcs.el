...
(defun darcs-read-file-name ()
  ...
  ;; Conal: Added oute file-name-directory and changed second
  ;; read-file-name argument from nil to t, since my shell can't handle
  ;; the "cd" that darcs-file-command generates.  Would be better to
  ;; complain if there's a directory given, rather than silently changing
  ;; semantics.
  (file-name-nondirectory
   (read-file-name "File or directory: " t nil t
